...
export const ContactForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Simulate successful submission (since backend is removed)
    setToast({
      show: true,
      message: 'Form validated successfully (no backend connected)',
      type: 'success'
    });
  ...
  return (
    <>
          <h4 style={{ textAlign: 'center', marginBottom: '20px' }}>Contact Us</h4>
